...
CURRENT_PATH = f'./research/models/opensmile_gemaps_normalised'
FEATURE_SET_CSV = 'opensmile_gemaps_features.csv'
...
MODEL_WEIGHTS_PATH = f'{CURRENT_PATH}/combined_feedforward_nn_opensmile_gemaps_normalised.pt'
