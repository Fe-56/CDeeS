...
CURRENT_PATH = f'./research/models/essentia_best_overall_normalised'
FEATURE_SET_CSV = ESSENTIA_BEST_OVERALL_FEATURES_CSV
...
MODEL_WEIGHTS_PATH = f'{CURRENT_PATH}/combined_feedforward_nn_essentia_best_overall_mean_normalised.pt'
...
test = {
  "extractor": {
    ...
    "feature_set": None,
    "feature_level": None,
    "essentia_feature_set": ESSENTIA_BEST_OVERALL
  },
